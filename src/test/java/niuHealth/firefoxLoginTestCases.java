...
public class firefoxLoginTestCases extends BaseClass{
	...
	public void configureReports()
	{
	 ...
	 @BeforeMethod
	   public void launchFirefox() {
		   driver = Browser.launchFirefoxBrowserNIUHealth();
	   }
	    
	    @Test
	    public void testLoginOnFireFoxBrowser() throws ParseException {
