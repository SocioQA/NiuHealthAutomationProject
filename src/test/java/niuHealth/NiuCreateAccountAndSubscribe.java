...
import pojo.Browser;
import pom.NiuCreateAccountPage;
import pom.NiuSubscriptionAndPaymentPage;
import utility.BaseClass;
import utility.Reports;
import utility.Screenshot;

public class NiuCreateAccountAndSubscribe extends BaseClass{
	 ...
	 @BeforeMethod
	   public void launchChrome() {
	    ...
	    public void testSuccessfulSubscription() {
	    	NiuCreateAccountPage createAcPage = new NiuCreateAccountPage(driver);
			...
			subscription.viewSubscribedPlanDetails();
	    }
		@AfterMethod
